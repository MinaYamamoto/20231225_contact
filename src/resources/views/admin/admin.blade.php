...
<div class="admin__content">
    ...
    <form class="admin-form" action="/admin/search" method="get">
        ...
        <div class="search-form__item">
            ...
            <input name="date" type="date" class="search-form__item-day" value="日付を入力してください"/>
        </div>
        <div class="flex__contents">
            <div class="export__button">
                <a href="{{ route('admin.exportcsv',['category_id' => $category_id, 'gender' => $gender,'date' => $date, 'keyword' => $keyword ]) }}" class="export__button-submit">エクスポート</a>
            </div>
            <div class="form__paginate">
                {{ $contacts->appends(request()->query())->links('vendor.pagination.tailwind2') }}
            </div>
        </div>
