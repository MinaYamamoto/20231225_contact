        ...
        <div class="form__group">
            ...
            <div class="form__group-content">
                <div class="form__input--tell">
                    <input type="tell" name="tell--1" placeholder="080" value="{{ old ('tell--1') }}" />
                    <p>-</p>
                    <input type="tell" name="tell--2" placeholder="1234" value="{{ old ('tell--2') }}" />
                    <p>-</p>
                    <input type="tell" name="tell--3" placeholder="5678" value="{{ old ('tell--3') }}" />
                </div>
                    <div class="form__error">
                        @error('tell--1')
                        {{ $message }}
